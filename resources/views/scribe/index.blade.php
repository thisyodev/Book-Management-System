...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authenticating-requests">
                    ...
                    <ul id="tocify-header-books-api" class="tocify-header">
                <li class="tocify-item level-1" data-unique="books-api">
                    <a href="#books-api">Books API</a>
                </li>
                                    <ul id="tocify-subheader-books-api" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="books-api-GETapi-books">
                                <a href="#books-api-GETapi-books">Get list of books (paginated)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="books-api-POSTapi-books">
                                <a href="#books-api-POSTapi-books">Create a new book</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="books-api-PUTapi-books--id-">
                                <a href="#books-api-PUTapi-books--id-">Update a book</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="books-api-DELETEapi-books--id-">
                                <a href="#books-api-DELETEapi-books--id-">Delete a book</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="books-api">Books API</h1>

    

                                <h2 id="books-api-GETapi-books">Get list of books (paginated)</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="books-api-POSTapi-books">Create a new book</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The title of the book. Example: <code>The Alchemist</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Author of the book. Example: <code>Paulo Coelho</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The year it was published. Example: <code>1988</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The genre. Example: <code>Fiction</code></p>
        </div>
        </form>

                    <h2 id="books-api-PUTapi-books--id-">Update a book</h2>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="genre"                data-endpoint="PUTapi-books--id-"
               value="Fiction"
               data-component="body">
    <br>
<p>The genre. Example: <code>Fiction</code></p>
                    ...
                    <h2 id="books-api-DELETEapi-books--id-">Delete a book</h2>
...
<form id="form-DELETEapi-books--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-books--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-books--id-"
                    onclick="cancelTryOut('DELETEapi-books--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
